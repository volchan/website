    ...
    >
      ...
      <div className="mt-7">
        <a
          ...
          className=" hover:text-indigo-500 text-xl lg:text-2xl"
        >
      ...
      <FontAwesomeIcon icon={faChevronDown} className="text-xl absolute bottom-16 sm:bottom-10 mx-auto motion-safe:animate-bounce" />
    </header>
  );
}
